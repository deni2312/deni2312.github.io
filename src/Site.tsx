...
function Site() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      {/* Hero Section */}
      <header className="bg-gradient-to-r from-purple-500 to-blue-500 py-20">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-300 text-center max-w-3xl mx-auto">
            With a over 5 years of experience in OpenGL, Unity, and Unreal Engine 5, I specialize in crafting real-time rendering engines, shaders, and other cool graphics programming stuff.
